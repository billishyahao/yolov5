...
def run(
    ...
    model.eval()
    # TODO: throw error about "required rank 4 tensor to use channels_last format"
    ...
    model = torch.jit.trace(model, dummy_input, check_trace=False).eval()
    ...
    print('yolov5n Average Inference Latency: %0.4f ms' % ( (t2-t1) * 1000.0 /loop))
